  ...
  return (
    <>
      ...
      <section className='servic'>
        ...
        <p className="servic_txt1">Если вы искали салон  штор в Караколе, где дизайнеры не просто создают изделия, которые закрывают Вас от окружающего мира, а создают продукцию, которая гармонирует с окружающим интерьером и выглядит так, словно это произведение искусства, то Вы оказались у нас не случайно. Для наших клиентов мы готовы предложить широкий ассортимент всевозможных гарнитур и тканей. Вы сможете выбрать их у нас на любой бюджет. Всего у нас представлено более 20 000 тканей европейских и турецких производителей. ПРИГЛАШАЕМ К СОТРУДНИЧЕСТВУ СВОБОДНЫХ ДИЗАЙНЕРОВ ИНТЕРЬЕРА И МЕБЕЛИ. ДЛЯ ВАС ОЧЕНЬ ИНТЕРЕСНОЕ СПЕЦИАЛЬНОЕ ПРЕДЛОЖЕНИЕ!!!</p>
        <div className="servic_cards flex">
          <div className="servic_left">
            <div className="servic_item">
              ...
              <p className="servic_txt">Качественно  шьем шторы, покрывала, занавески из тканей европейских и турецких производителей по доступным ценам </p>
